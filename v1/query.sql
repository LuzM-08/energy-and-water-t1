-- Query de creación del esquema 

CREATE DATABASE energy_and_water_v1;
CREATE USER 'grupo_martinez_carmona_figueroa'@'localhost' IDENTIFIED BY 'l4cl4v3-c11s4';
GRANT ALL PRIVILEGES ON energy_and_water_v1 . * TO 'grupo_martinez_carmona_figueroa'@'localhost';
FLUSH PRIVILEGES;

USE energy_and_water_v1;
